// Dafny program array_ex.dfy compiled into C#
...
[assembly: DafnyAssembly.DafnySourceAttribute(@"// Dafny 3.7.0.40620
// Command Line Options: c:\Users\gabriel.stundner\Metodos_Formais\Arrays\array_ex.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\array_ex
// array_ex.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      BigInteger[] _0_a;
      BigInteger[] _nw0 = Dafny.ArrayHelpers.InitNewArray1<BigInteger>(BigInteger.Zero, Dafny.Helpers.ToIntChecked(new BigInteger(4), "C# arrays may not be larger than the max 32-bit integer"));
      _0_a = _nw0;
