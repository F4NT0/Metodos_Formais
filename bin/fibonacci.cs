// Dafny program fibonacci.dfy compiled into C#
...
// Command Line Options: c:\Users\gabriel.stundner\Metodos_Formais\Invariantes\fibonacci.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\fibonacci
// fibonacci.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger ComputeFib(BigInteger n)
    {
      ...
      _1_y = BigInteger.One;
      while ((_0_i) < (n)) {
        BigInteger _rhs0 = _1_y;
        BigInteger _rhs1 = (x) + (_1_y);
        x = _rhs0;
        _1_y = _rhs1;
